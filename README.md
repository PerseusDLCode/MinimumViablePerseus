...
```sh
pdm run tokenizer --proto-dir ./proto-pages --nlp-url http://localhost:8000
```

You will need to change `./proto-pages` and `http://localhost:8000` to your own
proto-page directory and the URL where the [nlp_pipeline](https://github.com/PerseusDLCode/nlp_pipeline)
is reachable.
